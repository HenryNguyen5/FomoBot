...
// Viewers Component — Who has joined the portfolio, and who is viewing it.
  ...
  return (
    <section id='viewers'>
      <ReactCSSTransitionGroup
        className='viewers-portfolio-cntnr'
      ...
      <Footer id='viewer-count'>
        <FooterText>
          {activeCount}/{viewers.length} people are viewing this portfolio right now
        </FooterText>
      </Footer>
    </section>
  );
